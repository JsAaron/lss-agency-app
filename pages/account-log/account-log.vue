	...
	<app-layout>
		<view class="list">
			<view class="account-date main-center cross-center">
				<image @click="dateLess" class="account-icon" src="/static/image/myshop/icon/arrow-left.png"></image>
				<picker mode="date" :value="date" fields="month" @change="dateChange">
					<view>{{ date_a }}</view>
				</picker>
				<image @click="datePlus" class="account-icon" src="/static/image/myshop/icon/arrow-right.png"></image>
			</view>
