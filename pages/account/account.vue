...
export default {
	...
	methods: {
		navCash() {
			uni.navigateTo({
				url: `/pages/cash/cash?mch_id=` + this.mch_id + `&account_money=` + this.account_money
			});
		},
		navAccountLog() {
			uni.navigateTo({ url: `/pages/account-log/account-log?mch_id=` + this.mch_id });
		},
		navCashLog() {
			uni.navigateTo({ url: `/pages/cash-log/cash-log?mch_id=` + this.mch_id });
		},
		navSettleDetailN() {
			uni.navigateTo({ url: `/pages/settle-detail/settle-detail?is_transfer=0&mch_id=` + this.mch_id });
		},
		navSettleDetailY() {
			uni.navigateTo({ url: `/pages/settle-detail/settle-detail?is_transfer=1&mch_id=` + this.mch_id });
		},
		loadData: function() {
			const self = this;
