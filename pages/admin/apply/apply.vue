		...
		<view v-if="status === -1 || form_status">
			<view class="list dir-left-wrap">
				<view class="list-item">
					<view>
						<image src="/static/image/myshop/apply-tj.png"></image>
				...
				<view class="list-item">
					<view v-if="showZz">
						<image src="/static/image/myshop/apply-tj.png" v-if="showZz"></image>
						<view style="color: #FE4E4E;">资质信息</view>
					</view>
					<view v-else>
						<image src="/static/image/myshop/apply-wtj.png"></image>
						<view>资质信息</view>
					</view>
				</view>
...
export default {
	...
	methods: {
		...
		navApplyRules() {
			uni.navigateTo({ url: `/pages/admin/apply_rules/apply_rules?rules=` + this.setting.desc });
		},
		navHome() {
			uni.navigateTo({ url: `/pages/myshop/myshop` });
		},
		loadData: function() {
			const self = this;
			self.$showLoading();
...
.rules-box {
	...
	.icon-true {
		...
		width: #{32rpx};
		background-repeat: no-repeat;
		background-image: url('../../../static/image/myshop/apply-ok.png');
	...
	.icon-false {
		...
		width: #{32rpx};
		background-repeat: no-repeat;
		background-image: url('../../../static/image/myshop/apply-er.png');
		background-size: 100% 100%;
	}
