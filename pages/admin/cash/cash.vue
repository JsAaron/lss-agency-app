		...
		<view class="cash-head dir-top-nowrap main-center">
			...
			<view class="dir-left-nowrap cross-center cash-account-input">
				...
				<view class="box-grow-1 cross-center">
					<input
						class="cash-input-account"
						placeholder="输入提现金额"
						type="digit"
						placeholder-style="color:#cdcdcd;font-size:40rpx"
			...
			<view class="cash-btn main-center">
				<app-button @click="submit" height="80" width="702" background="#FF4544" font-size="32" color="#FFFFFF" round>
					提交申请
				</app-button>
			</view>
					...
					.then(info => {
						...
						uni.showModal({
							...
							success: function(e) {
								if (e.confirm) {
									if (info.code === 0) {
										uni.redirectTo({ url: '/pages/admin/cash-log/cash-log?mch_id=' + self.mch_id });
									}
								}
							}
						});
