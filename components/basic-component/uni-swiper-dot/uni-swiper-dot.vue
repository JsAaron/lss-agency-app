<template>
	<view class="uni-swiper__warp">
		...
		<view v-if="mode === 'customize' &&info.length > 1" key='indexes' class="uni-swiper__dots-box customize">
			<view v-for="(item,index) in info" :style="{
        'width':index === current?'20rpx':'16rpx','height': '6rpx' ,'background-color':index === current?'#ff4544':'#e2e2e2'}"
			 :key="index" class="uni-swiper__dots-item uni-swiper__dots-indexes"></view>
		</view>
	</view>
</template>
