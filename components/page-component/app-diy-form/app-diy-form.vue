<template>
    <view class="app-diy-form" :style="{
        ...
        <view :style="{
            ...
            <view class="list"
                  :class="[showItemBorder?'item-border':'', showAllItems?'show-all':'show-first',]">
                    ...
                    <view :key="index" v-if="item.key=='radio'"
                      ...
                      'margin-bottom': `${itemMarginY}rpx`,
                        ...
                        padding: labelPosition === 'top' ? `0 0` : `0 12rpx`,
                            ...
                            <app-radio-group :list="item.list" v-model="item.value" type="round"
                        ...
                        padding: labelPosition === 'top' ? `12rpx 0` : `12rpx 12rpx`,
                            ...
                            <template v-if="item.img_type == 1">
                                <app-upload-image
                                        ...
                                        :sign="`${index}`"
                                        :show-number="false"></app-upload-image>
                            </template>
